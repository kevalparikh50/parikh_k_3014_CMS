...
<?php
        ...
        echo "<td><a href='users.php?change_user={$user_id}'>user</a></td>";
...
if(isset($_GET['change_admin'])){
    ...
    $change_admin_query = mysqli_query($con,$query);
    // reload the page
...
if(isset($_GET['change_user'])){
    ...
    $the_user_id = $_GET['change_user'];
    
    $query = "UPDATE users SET user_role = 'user' WHERE user_id = $the_user_id";
    $change_user_query = mysqli_query($con,$query);
    // reload the page
   header("Location: users.php");
